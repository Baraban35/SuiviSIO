...
--
-- Client: 127.0.0.1
-- Généré le : Jeu 07 Mai 2015 à 00:01
...
--
-- CREATE DATABASE `portefeuille` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `portefeuille`;
...
CREATE TABLE IF NOT EXISTS `port_activitecitee` (
...
CREATE TABLE IF NOT EXISTS `port_cadre` (
...
--
-- Contenu de la table `port_cadre`
--
...
CREATE TABLE IF NOT EXISTS `port_commentaire` (
...
CREATE TABLE IF NOT EXISTS `port_competence` (
  `id` smallint(6) NOT NULL,
  `idActivite` smallint(6) NOT NULL,
...
--
-- Contenu de la table `port_competence`
--
...
CREATE TABLE IF NOT EXISTS `port_domaine` (
  `id` smallint(6) NOT NULL,
...
--
-- Contenu de la table `port_domaine`
--
...
CREATE TABLE IF NOT EXISTS `port_epreuve` (
  `id` smallint(6) NOT NULL,
  `nomenclature` char(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Contenu de la table `port_epreuve`
--
...
CREATE TABLE IF NOT EXISTS `port_esttypo` (
...
CREATE TABLE IF NOT EXISTS `port_evalue` (
...
--
-- Contenu de la table `port_evalue`
--
...
CREATE TABLE IF NOT EXISTS `port_exerce` (
...
--
-- Contenu de la table `port_exerce`
--
...
CREATE TABLE IF NOT EXISTS `port_exploite` (
  `idParcours` smallint(6) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `port_exploite`
--
...
CREATE TABLE IF NOT EXISTS `port_groupe` (
  `num` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `port_groupe`
--
...
CREATE TABLE IF NOT EXISTS `port_localisation` (
  `code` smallint(6) NOT NULL,
...
--
-- Contenu de la table `port_localisation`
--
...
CREATE TABLE IF NOT EXISTS `port_parcours` (
  `id` smallint(6) NOT NULL,
  `nomenclature` char(4) NOT NULL,
...
--
-- Contenu de la table `port_parcours`
--
...
CREATE TABLE IF NOT EXISTS `port_processus` (
  `id` smallint(6) NOT NULL,
...
--
-- Contenu de la table `port_processus`
--
...
CREATE TABLE IF NOT EXISTS `port_production` (
  `numero` int(11) NOT NULL AUTO_INCREMENT,
  `refSituation` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `port_situation` (
...
CREATE TABLE IF NOT EXISTS `port_source` (
  `code` smallint(6) NOT NULL,
  `libelle` char(20) NOT NULL,
...
--
-- Contenu de la table `port_source`
--
...
CREATE TABLE IF NOT EXISTS `port_typesource` (
  `code` smallint(6) NOT NULL,
...
--
-- Contenu de la table `port_typesource`
--
...
CREATE TABLE IF NOT EXISTS `port_typologie` (
  `code` smallint(6) NOT NULL,
  `lngutile` smallint(6) NOT NULL,
...
--
-- Contenu de la table `port_typologie`
--
